...
The structs that are relevant to this exploit are `Zip_FileHeader` and `ZIP_EndOfCentralDirRecord`. The [structs.c]({{ "/assets/files/CSGO0day/structs.c" }}) file is attached with their full definitions.
