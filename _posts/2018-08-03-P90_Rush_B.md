...
![]({{ "assets/images/Old_Bug.jpg" | absolute_url}})
...
![]({{ "assets/images/Strings_From_SRC.png" | absolute_url}})
...
![]( {{ "assets/images/bug_fix.png" | absolute_url}})
...
![]({{ "assets/images/vuln.png" | absolute_url}}) 
...
![]( {{ "assets/images/asm_example.png" | absolute_url}})
...
![]( {{"assets/images/csgo_calc.gif" | absolute_url }})
